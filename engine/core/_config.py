...
class BaseConfig(object):
    ...
    def __init__(self) -> None:
        ...
        self.use_swanlab :bool = False
        self.swanlab_project :str = "RT-DETRv2-OBB"
        self.swanlab_workspace :str = None
        self.swanlab_experiment :str = None
        self.swanlab_run_id :str = None
        self.swanlab_resume :str = None
